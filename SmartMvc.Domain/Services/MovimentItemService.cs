...
{
    public class MovimentItemService : Service<MovimentItem>, IMovimentItemService
    {
        public MovimentItemService(IMovimentItemRepository repository, IMovimentItemReadOnlyRepository readOnlyRepository)
