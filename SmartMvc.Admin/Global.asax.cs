...
using SmartMvc.Admin.AutoMapper;
using SmartMvc.Admin.Controllers;
...
namespace SmartMvc.Admin
{
    public class MvcApplication : HttpApplication
    {
        ...
        {
            if (ServiceLocator.Current.GetInstance<IContextManager<SmartContext>>() is ContextManager<SmartContext> contextManager)
            {
