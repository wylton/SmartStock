...
namespace SmartMvc.Data.Repository.EntityFramework.Common
{
        ...
        where TEntity : class
    {
        ...
        public Repository()
        {
            var contextManager = ServiceLocator.Current.GetInstance<IContextManager<SmartContext>>() 
                as ContextManager<SmartContext>;
